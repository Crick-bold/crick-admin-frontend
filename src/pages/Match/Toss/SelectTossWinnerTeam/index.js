...
const SelectTossWinnerTeam = ({tossWinner,setTossWinner, matchData, setSteps}) =>{
    return <>
                <div className="center-div">
                        <div className='flex justify-between w-70 align-center'>
                            <div className={tossWinner === 1 ?styles.selected_match_card:styles.match_card} onClick={()=>setTossWinner(1)}>
                            ...
                            <div class="p-8 text-24">
                                Who won the toss?
                            </div>
                            <div className={tossWinner === 2 ?styles.selected_match_card:styles.match_card} onClick={()=>setTossWinner(2)}>         
                                <div className={styles.match_card_image}>
